	...
	<!--start body-->
		<section class="section">
			...
			<div class="container-ingredients">
				<h2 class="container-ing__subtitle-ingredients">Ingredientes</h2>
				<li class="container-ing__list">
					<ol class="container-ing__list--item">Miel</ol>
					<ol class="container-ing__list--item">Aceite aromático</ol>
					<ol class="container-ing__list--item">Canela</ol>
					<ol class="container-ing__list--item">Manzanilla</ol>
				</li>
			</div>
